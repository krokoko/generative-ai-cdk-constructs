...
[@cdklabs/generative-ai-cdk-constructs](../../../../README.md) / [amazonconnect](../README.md) / UserBase
...
> **new UserBase**(`scope`, `id`, `props?`): `UserBase`
...
[`IUser`](../interfaces/IUser.md).[`env`](../interfaces/IUser.md#env)
...
[`IUser`](../interfaces/IUser.md).[`node`](../interfaces/IUser.md#node)
...
[`IUser`](../interfaces/IUser.md).[`stack`](../interfaces/IUser.md#stack)
...
[`IUser`](../interfaces/IUser.md).[`userArn`](../interfaces/IUser.md#userarn)
...
[`IUser`](../interfaces/IUser.md).[`applyRemovalPolicy`](../interfaces/IUser.md#applyremovalpolicy)
...
[`IUser`](../interfaces/IUser.md).[`grant`](../interfaces/IUser.md#grant)
